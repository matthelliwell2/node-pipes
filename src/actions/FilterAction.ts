import type { Action, AsyncAction, AsyncProcessMessage, Message } from './Action'
...
export class AsyncFilterAction<BI> implements AsyncAction<BI, BI> {
    ...
    onMessage: AsyncProcessMessage<BI, BI> = async (message: Message<BI>): Promise<Message<BI> | undefined> => {
